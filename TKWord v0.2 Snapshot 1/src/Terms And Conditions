...
Cookies
We employ the use of cookies. By accessing TKWord, you agreed to use cookies in agreement with the Crazi-RX's Privacy Policy.

Most interactive websites use cookies to let us retrieve the user’s details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.

License
Unless otherwise stated, Crazi-RX and/or its licensors own the intellectual property rights for all material on TKWord. All intellectual property rights are reserved. You may access this from TKWord for your own personal use subjected to restrictions set in these terms and conditions.

You must not:

Republish material from TKWord
Sell, rent or sub-license material from TKWord
Reproduce, duplicate or copy material from TKWord
Redistribute content from TKWord
Adding new code in TKWord application to fit your style is allowed.
...
You hereby grant Crazi-RX a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.
...
No use of Crazi-RX's logo or other artwork will be allowed for linking absent a trademark license agreement.
